...
const HappyTamagotchiSVG = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={300}
    viewBox="0 0 210 120"
    fill="none"
    ...
    >
      ...
      > 
        ...
        >
            ...
            <path d="M130 70H140V80H130V70Z" fill="#92D1FF" />
            <path d="M100 80H110V90H100V80Z" fill="#92D1FF" />
            <path d="M90 70H100V80H90V70Z" fill="#92D1FF" />
            <path d="M90 50H100V60H90V50Z" fill="#92D1FF" />
            <path d="M80 50H90V60H80V50Z" fill="#92D1FF" />
            <path d="M130 50H140V60H130V50Z" fill="#92D1FF" />
            <path d="M130 40H140V50H130V40Z" fill="#92D1FF" />
            <path d="M140 40H150V50H140V40Z" fill="#92D1FF" />
            <path d="M90 40H100V50H90V40Z" fill="#92D1FF" />
            <path d="M80 40H90V50H80V40Z" fill="#92D1FF" />
...
export default HappyTamagotchiSVG
